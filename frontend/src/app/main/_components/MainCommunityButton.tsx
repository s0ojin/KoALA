  ...
  return (
    <Link href="/community">
      <div className="inline-block relative w-auto">
        <span className="whitespace-nowrap py-3 px-5 select-none cursor-pointer absolute left-1 -top-6 bg-[#FF7A7A] text-white text-xs  rounded-full flex justify-center items-center font-semibold z-0">
          커뮤니티
        </span>
