...
export default function Main() {
  return (
    <MainLayout>
      <div className="w-full h-auto min-h-custom-height overflow-hidden relative select-none z-10 flex flex-col items-center">
        <Header />
        <div className="relative w-screen h-full min-h-custom-height flex max-w-[93.75rem]">
