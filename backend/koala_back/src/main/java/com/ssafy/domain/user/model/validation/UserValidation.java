...
public class UserValidation {
    ...
    public static void validate(final String loginId, final String password, final Auth auth, final String name, final String nickname, final Integer leaves, final Koala koala, final Long userExp, final Integer userLevel) {
